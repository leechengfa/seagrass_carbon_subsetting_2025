...
This report documents the method for selecting samples for the carbon content measurement of the _Zostera noltii_ seagrass. This is part of a larger project, which includes:
...
* [Analysing the carbon content in _Zostera noltii_ seagrass](https://leechengfa.github.io/seagrass_carbon_2025/)
...
Fieldwork was done in [Cadiz](https://sigoiry.github.io/Coring_Carbon_Seagrasses/), [Aveiro](https://sigoiry.github.io/Spectra_Aveiro_2025/) and [Bourgneuf Bay](https://sigoiry.github.io/Fieldtrip_Rewrite_Sept2025/). These three sites have been covered in @davies2024.
...
Of the stations with hyperspectral measurements, `r csv.biomass.AV %>% filter(seagrassA < recommended_minimum | seagrassB < recommended_minimum) %>% select(spectra) %>% sum()` have too little samples for the carbon measurement, which required a minimum of 70 mg for the total carbon content measurement and about 300 mg for the total inorganic carbon content measurement. They are:
...
Of the stations with hyperspectral measurements, `r csv.biomass.BB %>% filter(A < recommended_minimum | B < recommended_minimum) %>% select(spectra) %>% sum()` stations have too little samples for the carbon measurement. They are:
